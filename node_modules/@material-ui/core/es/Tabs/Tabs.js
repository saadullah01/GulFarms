...
const Tabs = React.forwardRef(function Tabs(props, ref) {
  const {
    ...
    variant = 'standard'
        ...
        other = _objectWithoutPropertiesLoose(props, ["action", "centered", "children", "classes", "className", "component", "indicatorColor", "onChange", "orientation", "ScrollButtonComponent", "scrollButtons", "TabIndicatorProps", "TabScrollButtonProps", "textColor", "value", "variant"]);
  ...
  const indicator = /*#__PURE__*/React.createElement(TabIndicator, _extends({
    ...
    style: _extends(_extends({}, indicatorStyle), TabIndicatorProps.style)
  }));
  let childIndex = 0;
